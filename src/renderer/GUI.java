...
public abstract class GUI {
	...
	public int[] getLeftDirectLight() {
		return new int[] { lRed.getValue(), lGreen.getValue(), lBlue.getValue() };
	}

	public int[] getRightDirectLight() {
		return new int[] { rRed.getValue(), rGreen.getValue(), rBlue.getValue() };
	}

	public boolean getLCheckBox() {
	...
	public final JSlider lRed = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	public final JSlider lGreen = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	public final JSlider lBlue = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	public final JSlider rRed = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	public final JSlider rGreen = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	public final JSlider rBlue = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);


	public JCheckBox lCheckBox = new JCheckBox();
	public JCheckBox rCheckBox = new JCheckBox();
	...
	private void initialise() {
		...
		JPanel lSliderparty = new JPanel();
		lSliderparty.setLayout(new BoxLayout(lSliderparty, BoxLayout.PAGE_AXIS));
		lSliderparty.setBorder(BorderFactory.createTitledBorder("Left Direct Light"));

		lSliderparty.add(lRed);
		lSliderparty.add(lGreen);
		lSliderparty.add(lBlue);
		lRed.setBackground(new Color(230, 50, 50));
		lGreen.setBackground(new Color(50, 230, 50));
		lBlue.setBackground(new Color(50, 50, 230));

		JPanel rSliderparty = new JPanel();
		rSliderparty.setLayout(new BoxLayout(rSliderparty, BoxLayout.PAGE_AXIS));
		rSliderparty.setBorder(BorderFactory.createTitledBorder("Right Direct Light"));

		rSliderparty.add(rRed);
		rSliderparty.add(rGreen);
		rSliderparty.add(rBlue);
		rRed.setBackground(new Color(230, 50, 50));
		rGreen.setBackground(new Color(50, 230, 50));
		rBlue.setBackground(new Color(50, 50, 230));
		...
		controls.add(lCheckBox);
		controls.add(lSliderparty);
		controls.add(rCheckBox);
		controls.add(rSliderparty);
